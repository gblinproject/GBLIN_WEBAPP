...
export const metadata: Metadata = {
  ...
  description:
    'Inspect the GBLIN vault: open-source Solidity verified on Basescan, governed by a 48h public timelock. Live reserves, NAV per share and auction state on Base mainnet.',
